...
impl AnalysisMetadata for TypeScriptPlugin {
    fn test_patterns(&self) -> Vec<Regex> {
        vec![
            Regex::new(r"\bit\(").unwrap(),
            Regex::new(r"\btest\(").unwrap(),
            Regex::new(r"\bdescribe\(").unwrap(),
            Regex::new(r"\bbeforeEach\(").unwrap(),
            Regex::new(r"\bafterEach\(").unwrap(),
        ]
    }
    ...
    fn assertion_patterns(&self) -> Vec<Regex> {
        vec![
            ...
            Regex::new(r"\.toBe\(").unwrap(),
            Regex::new(r"\.toEqual\(").unwrap(),
    ...
    fn interface_keywords(&self) -> Vec<&'static str> {
        vec!["interface", "type", "class"]
    }

    fn complexity_keywords(&self) -> Vec<&'static str> {
        vec![
            "if", "else", "switch", "case", "for", "while", "do", "catch", "&&", "||", "?",
        ]
    }
