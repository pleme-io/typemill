# 🤖 codeflow-buddy
**Enterprise-grade MCP server** bridging Language Server Protocol functionality to AI coding assistants with **35 MCP tools** and **WebSocket deployment**

## ✨ What It Does

**35 MCP tools** that give AI assistants LSP superpowers:
