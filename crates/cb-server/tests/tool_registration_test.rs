...
#[tokio::test]
async fn test_all_43_tools_are_registered() {
    ...
    const EXPECTED_TOOLS: [&str; 43] = [
        ...
        "update_dependencies", "extract_module_to_package", "update_dependency",
        // Advanced (2)
    ...
    assert_eq!(registered_tools.len(), EXPECTED_TOOLS.len(),
    ...
    assert!(missing.is_empty(), "The following tools are missing: {:?}", missing);
}
