...
define_language_plugin! {
    ...
    fields: {
        ...
        file_discovery: RustFileDiscovery,
    },
    doc: "Rust language plugin implementation"
}

#[async_trait]
impl FileDiscovery for RustFileDiscovery {
    async fn find_source_files(&self, root_path: &Path) -> PluginResult<Vec<std::path::PathBuf>> {
        let discovery = StandardFileDiscovery::new(RustPlugin::METADATA.extensions);
