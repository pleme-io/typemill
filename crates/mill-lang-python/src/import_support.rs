...
impl ImportParser for PythonImportSupport {
...
impl ImportRenameSupport for PythonImportSupport {
...
impl ImportMoveSupport for PythonImportSupport {
    fn rewrite_imports_for_move(
        ...
        // Use rename logic from ImportRenameSupport trait
        ImportRenameSupport::rewrite_imports_for_rename(self, content, &old_module, &new_module)
    }
}

impl ImportMutationSupport for PythonImportSupport {
...
impl ImportAdvancedSupport for PythonImportSupport {
    fn update_import_reference(
        ...
        debug!(
            old_reference = %update.old_reference,
            new_reference = %update.new_reference,
            "Updating Python import reference using advanced support"
        );

        // Use the existing rename functionality to update imports
        ...
        debug!(
            changes_count = changes,
            "Completed advanced import reference update"
        );
