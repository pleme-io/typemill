...
fn main() {
    ...
    let config: LanguagesConfig =
        toml::from_str(&config_content).expect("Failed to parse languages.toml");
...
fn generate_language_enum(config: &LanguagesConfig, out_dir: &Path) {
    ...
    fs::write(out_dir.join("language_enum.rs"), output).expect("Failed to write language_enum.rs");
}

fn generate_metadata_constants(config: &LanguagesConfig, out_dir: &Path) {
    let mut output = String::from(
        "// Generated by build.rs from languages.toml - DO NOT EDIT\n\n\
...
fn generate_registry_registration(config: &LanguagesConfig, out_dir: &Path) {
    let mut output =
        String::from("// Generated by build.rs from languages.toml - DO NOT EDIT\n{\n");
