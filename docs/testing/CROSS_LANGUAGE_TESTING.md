...
1. **Refactoring Harness** (`integration-tests/src/harness/refactoring_harness.rs`)
...
```rust
// In integration-tests/src/harness/refactoring_harness.rs
...
- [integration-tests/src/harness/refactoring_harness.rs](../../integration-tests/src/harness/refactoring_harness.rs) - Harness implementation
