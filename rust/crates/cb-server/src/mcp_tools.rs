...
pub fn get_tool_definitions() -> Vec<Value> {
    vec![
        ...
        json!({
            "name": "apply_edits",
            "description": "Apply an EditPlan to the filesystem atomically. Takes an EditPlan generated by rename_symbol_with_imports or other refactoring tools and applies all text edits and dependency updates to files. This completes the refactoring workflow.",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "edit_plan": {
                        "type": "object",
                        "description": "The EditPlan to apply, containing file edits and dependency updates",
                        "properties": {
                            "source_file": { "type": "string", "description": "Source file being edited" },
                            "edits": {
                                "type": "array",
                                "description": "List of individual edits to apply",
                                "items": {
                                    "type": "object",
                                    "properties": {
                                        "edit_type": { "type": "string", "description": "Type of edit (rename, add_import, etc.)" },
                                        "location": {
                                            "type": "object",
                                            "properties": {
                                        ...
                                        "original_text": { "type": "string", "description": "Original text to be replaced" },
                                        "new_text": { "type": "string", "description": "New text to insert" },
                                        "priority": { "type": "number", "description": "Edit priority (higher numbers applied first)" },
                                        "description": { "type": "string", "description": "Description of what this edit does" }
                                    },
                                    "required": ["edit_type", "location", "original_text", "new_text", "priority", "description"]
                                }
                            },
                            "dependency_updates": {
                                "type": "array",
                                "description": "Dependencies that need to be updated",
                                "items": {
                                    "type": "object",
                                    "properties": {
                                        "target_file": { "type": "string", "description": "File whose imports need updating" },
                                        "update_type": { "type": "string", "description": "Type of update needed" },
                                        "old_reference": { "type": "string", "description": "Old import path/name" },
                                        "new_reference": { "type": "string", "description": "New import path/name" }
                                    },
                                    "required": ["target_file", "update_type", "old_reference", "new_reference"]
                                }
                            },
                            "validations": { "type": "array", "description": "Validation rules to check after editing" },
                            "metadata": {
                                "type": "object",
                                "description": "Plan metadata",
                                "properties": {
                                    "intent_name": { "type": "string" },
                                    "intent_arguments": { "type": "object" },
                                    "created_at": { "type": "string" },
                                    "complexity": { "type": "number" },
                                    "impact_areas": { "type": "array", "items": { "type": "string" } }
                                },
                                "required": ["intent_name", "intent_arguments", "created_at", "complexity", "impact_areas"]
                            }
                        },
                        "required": ["source_file", "edits", "dependency_updates", "validations", "metadata"]
                    }
                },
                "required": ["edit_plan"]
            }
