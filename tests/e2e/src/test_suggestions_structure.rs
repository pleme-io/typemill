...
#[tokio::test]
async fn test_structure_analysis_generates_suggestions() {
    let server = setup_test_server().await;
    let fixture = TestFixture::new("typescript", "deep-hierarchy.ts").await;
    ...
    assert!(!findings.is_empty(), "Should have hierarchy findings");
