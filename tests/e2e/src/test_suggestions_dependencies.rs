...
#[tokio::test]
async fn test_dependency_analysis_generates_suggestions() {
    let server = setup_test_server().await;
    let fixture = TestFixture::new("typescript", "circular-dependency/a.ts").await;
    ...
    assert!(!findings.is_empty(), "Should have circular dependency findings");
